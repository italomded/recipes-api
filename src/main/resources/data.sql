...
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (2, 'Do this and to that', 3, 3, 'KG', 1, 2, 1);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (3, 'Do this and to that', 1, 300, 'ML', 1, 3, 1);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (4, 'Do this and to that', 2, 20, 'G', 1, 4, 1);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (5, 'Do this and to that', 7, 1, 'L', 1, 5, 1);

INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (6, 'Do this and to that', 4, 20, 'MG', 1, 9, 2);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (7, 'Do this and to that', 3, 3, 'KG', 1, 2, 2);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (8, 'Do this and to that', 1, 300, 'ML', 1, 3, 2);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (9, 'Do this and to that', 2, 20, 'G', 1, 4, 2);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (10, 'Do this and to that', 7, 1, 'L', 1, 10, 2);

INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (11, 'Do this and to that', 4, 20, 'MG', 1, 9, 3);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (12, 'Do this and to that', 3, 3, 'KG', 1, 8, 3);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (13, 'Do this and to that', 1, 300, 'ML', 1, 7, 3);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (14, 'Do this and to that', 2, 20, 'G', 1, 4, 3);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (15, 'Do this and to that', 7, 1, 'L', 1, 5, 3);

INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (16, 'Do this and to that', 4, 20, 'MG', 1, 6, 4);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (17, 'Do this and to that', 3, 3, 'KG', 1, 7, 4);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (18, 'Do this and to that', 1, 300, 'ML', 1, 8, 4);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (19, 'Do this and to that', 2, 20, 'G', 1, 4, 4);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (20, 'Do this and to that', 7, 1, 'L', 1, 5, 4);

INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (21, 'Do this and to that', 4, 20, 'MG', 1, 7, 5);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (22, 'Do this and to that', 3, 3, 'KG', 1, 2, 5);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (23, 'Do this and to that', 1, 300, 'ML', 1, 8, 5);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (24, 'Do this and to that', 2, 20, 'G', 1, 4, 5);
INSERT INTO recipe_ingredient (id, instruction, prepare_minutes, amount, measure, `sequence`, ingredient_id, recipe_id)
	VALUES (25, 'Do this and to that', 7, 1, 'L', 1, 5, 5);
